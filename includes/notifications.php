    ...
    if ($request) {
        ...
        if (!empty($request['email'])) {
            $email_message = "
                ...
                <p>Thank you,<br>CSM Laboratory Staff</p>
            ";
            send_email_notification($request['email'], 'CSM Borrow Request Approved', $email_message);
        }
    }
}
    ...
    if ($penalty) {
        ...
        if (!empty($penalty['email'])) {
            $email_message = "
                ...
                <p>Thank you,<br>CSM Laboratory Staff</p>
            ";
            send_email_notification($penalty['email'], 'CSM Penalty Notice', $email_message);
        }
    }
}
